...
L.OWM = L.TileLayer.extend({
	options: {
		appId: 'f9ed38483e00706d5dd69595de9477e7', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		...
		minZoom: 7,
		interval: 5, // interval for rereading city data in minutes
		progressControl: true, // available: true, false
		imageLoadingUrl: 'https://github.com/buche/leaflet-openweathermap/blob/master/owmloading.gif?raw=true', // URL of loading image relative to HTML document
